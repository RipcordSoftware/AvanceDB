...
${OBJECTDIR}/futon_web_site_resource.o: futon_web_site_resource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/libhttpserver/src `pkg-config --cflags gnutls` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/futon_web_site_resource.o futon_web_site_resource.cpp

${OBJECTDIR}/http_extn_mime_map.o: http_extn_mime_map.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/libhttpserver/src `pkg-config --cflags gnutls` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/http_extn_mime_map.o http_extn_mime_map.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../externals/libhttpserver/src `pkg-config --cflags gnutls` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
